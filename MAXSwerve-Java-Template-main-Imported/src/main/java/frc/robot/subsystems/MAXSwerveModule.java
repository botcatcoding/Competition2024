...
public class MAXSwerveModule {
    ...
    public String diagnostic() {
        String turningMotorFault = diagnoseSparkMotor(m_turningSparkMax);
        String drivingMotorFault = diagnoseSparkMotor(m_drivingSparkMax);
        // System.out.println(turningMotorFault);
        String faults = "";
        boolean faultered = false;
        if (turningMotorFault != null) {
            faults += turningMotorFault + ", ";
            faultered = true;

        }
        if (drivingMotorFault != null) {
            faults += drivingMotorFault + ", ";
            faultered = true;
        ...
        return null;
        // if(m_drivingSparkMax.getFirmwareVersion())
    }
}

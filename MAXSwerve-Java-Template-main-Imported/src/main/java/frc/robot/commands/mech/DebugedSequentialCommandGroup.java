 ...
 */
public class DebugedSequentialCommandGroup extends Command {
     ...
     */
    public DebugedSequentialCommandGroup(Command... commands) {
    ...
    public final boolean isFinished() {
        // System.out.println(m_currentCommandIndex + ":" + m_commands.size());
        return m_currentCommandIndex == m_commands.size() || ended;
    }

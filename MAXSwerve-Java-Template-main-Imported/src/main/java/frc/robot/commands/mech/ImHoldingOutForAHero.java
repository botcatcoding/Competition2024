...
public class ImHoldingOutForAHero extends SequentialCommandGroup {
    ...
    public ImHoldingOutForAHero(Shooter sho, Elbow e, Shoulder sh, Slurp sl, DigitalInput sd, Kinamatics k) {
        ...
        SetElbowByRotationSafe moveElbowToPos = new SetElbowByRotationSafe(.35, true, .1,
        ...
        SetElbowByRotationSafe holdElbowAtPos = new SetElbowByRotationSafe(.35, true, .1,
                Constants.MechConstants.shoulderSafeZone, false, sh, e);
        ...
        ParallelCommandGroup shootIt = new ParallelCommandGroup(feedIt, keepUp, holdShoulderAtPos, holdElbowAtPos);
        ParallelCommandGroup spinUpButDontFeedIt = new ParallelCommandGroup(dontFeedIt, spinUp, moveShoulderToPos,
                moveElbowToPos);

...
public class AimAndDriveCommand extends CommandBase {
    Arm arm;
    ...
    public void execute() {
        ...
        System.out.println(Rotation2d.fromRadians(shoulderAngle).getDegrees()+"\t"+Rotation2d.fromRadians(kr.elbowAngle).getDegrees()+"\t"+ Rotation2d.fromRadians(kr.yaw).getDegrees());
    ...
    public static KinematicsResult calculateArmKinematics(double tx ,double ty, double tz, double bx, double by, double bz, double sa)
    {
